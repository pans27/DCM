...
class VVIRparameter(tkinter.Frame):
    ...
    def write_vvir_parameters(self):
        ...
        self.hys.set(cUser.vvir.getARP())
        ...
        self.rates.set(cUser.vvir.getARP())
        ...
        self.ret.set(cUser.vvir.getVPW())
